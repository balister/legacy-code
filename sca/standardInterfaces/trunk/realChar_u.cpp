...
standardInterfaces_i::realChar_u::realChar_u(const char* _portName) 
{
    portName = _portName;
...
standardInterfaces_i::realChar_u::realChar_u(const char* _name, const char* _domain) : portName(_name)
{
...
standardInterfaces_i::realChar_u::~realChar_u()
{

}

CORBA::Object_ptr standardInterfaces_i::realChar_u::getPort(const char* _portName)
{
...
{
    standardInterfaces::realChar_ptr p = standardInterfaces::realChar::_narrow(connection);
    if (CORBA::is_nil(p)) {
	DEBUG(1, standardInterfaces, "Attempt to connect a realChar uses port to a port that does not provide a realChar interface.");
	return;
    }
