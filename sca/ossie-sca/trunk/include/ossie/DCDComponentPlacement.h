...
#include "ossie/DCDComponentInstantiation.h"
...
{
public:
    DCDComponentPlacement(TiXmlElement *elem);
...
protected:
    void parseElement();
    void parseDeployOnDevice(TiXmlElement *elem);
    void parseCompositePartOfDevice(TiXmlElement *elem);
    void parseDPDFileName(TiXmlElement *elem);
    void parseInstantiations(TiXmlElement *elem);
