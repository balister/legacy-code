...
ComponentInfo::ComponentInfo() : isAssemblyController(false), isResource(false), isConfigurable(false), deployedOnResourceFactory(false), deployedOnLoadableDevice(false), deployedOnExecutableDevice(false)
{
}
...
void ComponentInfo::setDeployedOnResourceFactory(bool _deployedOnResourceFactory)
{
    deployedOnResourceFactory = _deployedOnResourceFactory;
}

void ComponentInfo::setDeployedOnLoadableDevice(bool _deployedOnLoadableDevice)
{
    deployedOnLoadableDevice = _deployedOnLoadableDevice;
}

void ComponentInfo::setPID(CF::ExecutableDevice::ProcessID_Type _pid)
{
    PID = _pid;
}

void ComponentInfo::setDeployedOnExecutableDevice(bool _deployedOnExecutableDevice)
{
    deployedOnExecutableDevice = _deployedOnExecutableDevice;
}
...
void ComponentInfo::setDevicePtr(CF::Device_ptr _dev)
{
    devicePtr = _dev;
}
...
const bool  ComponentInfo::getDeployedOnLoadableDevice()
{
    return deployedOnLoadableDevice;
}
const bool  ComponentInfo::getDeployedOnExecutableDevice()

{
    return deployedOnExecutableDevice;
}

const CF::ExecutableDevice::ProcessID_Type ComponentInfo::getPID()
{
    return PID;
}

const bool  ComponentInfo::getDeployedOnResourceFactory()
{
    return deployedOnResourceFactory;
}
...
CF::Device_ptr ComponentInfo::getDevicePtr()
{
    return CF::Device::_duplicate(devicePtr);
}
