...
db_flex::~db_flex()
{
    int P(0), PD(3), CP2(0), CP1(0), PL(0), MTLD(1), CPG(0), CP3S(0), PDP(1), MUXOUT(0), CR(0), PC(1);
    int control = (P<<22) | (PD<<20) | (CP2<<17) | (CP1<<14) | (PL<<12) | (MTLD<<11) | (CPG<<10) | (CP3S<<9) | (PDP<<8) | (MUXOUT<<5) | (CR<<4) | (PC<<2);
