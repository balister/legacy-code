...
// Device methods
CF::Device::UsageType USRP_i::usageState() throw (CORBA::SystemException)
{
    return dev_usageState;
}

CF::Device::AdminType USRP_i::adminState() throw (CORBA::SystemException)
{
    return dev_adminState;
}

CF::Device::OperationalType USRP_i::operationalState() throw (CORBA::SystemException)
{
    return dev_operationalState;
}

CF::AggregateDevice_ptr USRP_i::compositeDevice() throw (CORBA::SystemException)
{
    return NULL;
}

void USRP_i::adminState (CF::Device::AdminType _adminType)
throw (CORBA::SystemException)
{
    dev_adminState = _adminType;
}

CORBA::Boolean USRP_i::allocateCapacity (const CF::
...
void USRP_i::deallocateCapacity (const CF::Properties & capacities)
throw (CORBA::SystemException, CF::Device::InvalidCapacity,
CF::Device::InvalidState)
{
...
char *USRP_i::identifier () throw (CORBA::SystemException)
{
    return CORBA::string_dup(dev_id.c_str());
}


// Port Supplier methods
...
void USRP_i::runTest (CORBA::ULong _number, CF::Properties & _props)
